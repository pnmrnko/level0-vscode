...
- Download what is missing. On a member line whose object is not in the document, the code action menu (the lightbulb, Cmd/Ctrl+.) offers "Download node 123", and for ways and relations also "with its nodes" or "with its members". On any line of a way or relation, or over a selection spanning several objects, it offers the missing members of those objects in one go, fetched in batches per type.
